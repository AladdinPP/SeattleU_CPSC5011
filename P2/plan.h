...
// The plan class simulates a plan consisting of multiple formulas.
// Class Invariants:
// 1.   The size attribute always reflects the actual number of formulas
//      in the plan.
// 2.   The capacity attribute must always be equal to or greater than size,
//      ensuring there is space for new formulas without immediate resizing.
class plan {
private:
    formula* planList;
    int size, capacity;
